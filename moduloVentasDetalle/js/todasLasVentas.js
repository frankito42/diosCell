...
async function dibujarVentas(params) {
    ...
    params.forEach((element,i) => {
        ...
        if(i==params.length-1){
            ...
            <div class="media-body">
            <h6 class="mt-1 font-weight-bold"><a href="#!"><span style="font-size: 125%;">TOTAL De ventas</span></a><a><span style="font-size: 226%;" class="badge badge-success float-right">$${separator(sumaTotal.toFixed(2))}</span></a></h6>
            </div>
            </div>
            `
