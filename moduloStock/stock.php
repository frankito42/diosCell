			...
			<div class="container-fluid">
				<div class="row">
					...
					<div style="margin-top: 6%;" class="col">
								...
								<select required id="newArticuloEnEstablecimiento" name="newArticuloEnEstablecimiento" class="form-control">
								</select>	
					...
					<div class="col">
                          ...
                          <div class="col">
                            <div class="md-form">
                              ...
                              <label for="precioArticulo2" class="active">Guarani</label>
                            </div>
                          </div>
				</div>
                ...
                <!-- ////////////////////////////////////////////////// -->
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                        <a onclick="brcode('codBarraNew','bcTarget')" class="btn btn-blue">Generar</a> 
<!--                         <a id="btnEscanear" class="btn btn-blue btn-lg"><i class="fa fa-camera"></i> <i class="fas fa-barcode"></i></a>
 -->                        </div>
                    </div>
                    <div class="row text-center">
                        <div class="col">
                            <div style="margin:0 auto;" id="bcTarget"></div>  
                             
                            <a onclick="imprSelec('bcTarget')" class="btn btn-blue">imprimir</a>  
                        </div>
                    </div>
            </div> 
            <!-- /////////////////////////////ERROR ERROR//////////////////////////////////////////// -->
...
<script src="../barcode/barcode.js"></script>
<script src="../mdb/js/bootstrap.min.js"></script>
<script src="../mdb/js/mdb.min.js"></script>
<script src="../mdb/js/all.min.js"></script>
<script src="js/stock.js?polpol=popol"></script>
