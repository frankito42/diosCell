document.addEventListener("DOMContentLoaded",async function(event) {
    ...
    document.getElementById("seleccionEstaForm").addEventListener("submit",async (e)=>{
        ...
        await fetch('php/seleccionarEsta.php',{
            method:"POST",
            body:formData
        })
      ...
      .then(async (data) => {
        ...
        if (data=="okey") {
            ...
            esta.nombreDeEstablecimiento="Establecimiento "+document.getElementById("selectEsta").options[document.getElementById("selectEsta").selectedIndex].text;
