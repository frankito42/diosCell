...
$categoriasAll=$conn->prepare($sqlCategorias);
$categoriasAll->execute();
$categoriasAll=$categoriasAll->fetchAll(PDO::FETCH_ASSOC);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    <section>
        ...
        <a class="navbar-brand" href="#">DIOS CEL</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent-4">
            ...
            <li class="nav-item dropdown">
                  ...
                  <a class="dropdown-item waves-effect waves-light" href="categorias.php">Categorias</a>
    ...
    <div class="container">
    <button class="btn btn-blue" data-toggle="modal" data-target="#addCategoria">Nueva Categoria</button>
        <table class="table table-hover">
            <thead style="background: #ffe251a3;">
                <tr>
                    <th>ID</th>
                    <th>Categoria</th>
                    <th></th>
            ...
            <tbody>
            <?php foreach ($categoriasAll as $key):?>
                <tr>
                    <td><?php echo $key['idCategoria']?></td>
                    <td><?php echo $key['nombreCategoria']?></td>
                    <td><a href="php/delete.php?id=<?php echo $key['idCategoria']?>" class="btn btn-danger">x</a></td>
                </tr>
            <?php endforeach?>
            </tbody>
        </table>
   ...
   <div style="margin: 5.75rem auto !important;" class="modal-dialog modal-notify modal-success" role="document">
     ...
     <div class="modal-content">
       ...
       <div style="margin-left: 5%;margin-right: 5%;margin-top: -5%;box-shadow: 0px 0px 20px 0px #00000073;" class="modal-header">
         <p style="padding: 3%;" class="heading lead">Añadir Categoria</p>

         <button type="button" class="close" data-dismiss="modal" aria-label="Close">
           <span aria-hidden="true" class="white-text">&times;</span>
         </button>
       </div>
      <form action="php/addCategoria.php" method="post">
       <!--Body-->
       <div class="modal-body">
         
          <div class="md-form">
            <input required type="text" name="categoria" id="categoria" value="" class="form-control">
